...
const executeQuery = async (
  ...
  try {
    ...
    const serverApiBaseUrl =
      queryDetails.serverApiBaseUrlResolver(dsModelValues);
    ...
    queryResponse.data =
      Platform.OS === 'web'
        ? await fetch(`${serverApiBaseUrl}api/themes/`, {
            headers: {'x-base-url': apiBaseUrl + endpoint},
          }).then(res => res.json())
        : await fetch(apiBaseUrl + endpoint).then(res => res.json());
    const rawData =
